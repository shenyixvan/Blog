export const SITE_TITLE = `ZhongZhi Blog`;
export const SITE_DESCRIPTION = 'Site Description';
export const SITE_EMAIL = 'no.sql@qq.com'
export const SITE_NAME = 'www.zhongzhiteam.com';
export const SITE_URL = "https://www.zhongzhiteam.com";
